  ...
  return (
    <>
      ...
      <header
        ...
        style={{ background: 'rgba(22,42,72,0.97)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}
      >
      ...
      <nav
        ...
        style={{ background: 'rgba(22,42,72,0.99)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}
      >
        ...
        <div style={{ height: 'env(safe-area-inset-bottom)', background: 'rgba(22,42,72,0.99)' }} />
      </nav>
    </>
  );
}
